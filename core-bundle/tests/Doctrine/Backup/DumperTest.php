    ...
    public function successfulDumpProvider(): \Generator
    {
        ...
        yield 'Table with binary data' => [
            [new Table('tl_page', [
                ...
                new Column('x_array', Type::getType(Types::JSON)),
                ...
                new Column('x_object', Type::getType(Types::JSON)),
            ...
            [
                ...
                '-- BEGIN STRUCTURE tl_page',
                'DROP TABLE IF EXISTS `tl_page`;',
                "CREATE TABLE `tl_page` (`x_string` VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL, `x_array` JSON NOT NULL, `x_ascii` VARCHAR(255) NOT NULL, `x_binary` VARBINARY(255) NOT NULL, `x_blob` LONGBLOB NOT NULL, `x_object` JSON NOT NULL, `x_simple_array` LONGTEXT NOT NULL);",
                '-- BEGIN DATA tl_page',
